...
def build_cnn():
    ...
    model.add(Dense(50, activation='relu', kernel_regularizer=l2(1e-4)))
...
def load_dataset(csv_path):
    ...
    image_paths = df[0].values        # center camera
...
def main():
    ...
    X_train, X_temp, y_train, y_temp = train_test_split(image_paths, steering, test_size=0.3, random_state=42)
    ...
    checkpoint = ModelCheckpoint("cnn_steering.h5", monitor="val_loss", save_best_only=True)
